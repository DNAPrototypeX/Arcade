...
import random
pygame.init()
collide_player = pygame.mixer.Sound('pong_player_collide.wav')
collide_wall = pygame.mixer.Sound('pong_wall_collide.wav')
point_scored = pygame.mixer.Sound('pong_point_scored.wav')
